...
//        OnRoundResultCallback();
    ...
    {
        Debug.Log("RockSpockSceneController.InitGame() p1:" + gameState.players_data[0].id + "p2:" +
                  gameState.players_data[1].id);

        if (Constants.USER_ID != -1)
        {
            Debug.Log("RockSpockSceneController.InitGame() WE PLAYING");
            // if we are playing
        ...
        {
            Debug.Log("RockSpockSceneController.InitGame() WE WATCHING");
        ...
        {
            case 1: //ready
                Debug.Log("RockSpockSceneController gameState.state ready");
    ...
    {
        Debug.Log("RockSpockSceneController InitReadyState ShowUI()");
        uiController.ShowUI();
    }
    ...
    {
        Debug.Log("RockSpockSceneController ShowGame isAnimate = " + isAnimate);
        switch (Constants.SELF_INDEX)
        {
            case -1: //not playing, just watching
